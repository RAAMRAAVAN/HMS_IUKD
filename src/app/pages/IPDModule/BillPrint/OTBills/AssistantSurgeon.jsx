import { setItemDiscountAssistant } from "@/src/lib/features/otDiscount/otDiscountSlice";
...
export const AssistantSurgeon = (props) => {
  ...
  useEffect(() => {
    ...
    dispatch(setItemDiscountAssistant({AssistantDiscountAmount: totalDiscount, index: index}));
