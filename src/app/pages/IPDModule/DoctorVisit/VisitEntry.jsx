...
export const VisitEntry = (props) => {
  ...
  const UpdateVisitDetails = async(A, D) => {
    ...
    try{
      let result = await axios.post('http://192.168.1.108:5000/UpdateVisitDetails', {AID: AID,ActiveStatus: A, DeleteStatus: D, Date: VisitDate, NoOfVisit: NoOfVisit, Discount: Discount, Amount: Amount, Rate: Rate, User: "1"})
