...
export const ServiceEntries = (props) => {
  ...
  const getServiceEntriesDetails = async() => {
    ...
    try{
        let result = await axios.post('http://192.168.1.108:5000/getServiceListDetails', {OSID: OSID});
  ...
  const deleteOtherServiceEntries = async (Act, Del) => {
    try{
      let result = await axios.post('http://192.168.1.108:5000/deleteOtherServiceEntries', {OSID: OSID, ActiveStatus:Act, DeleteStatus: Del});
