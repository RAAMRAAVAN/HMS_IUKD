...
export default function page() {
  ...
  useEffect(()=>{
    if(UserID !== null)
      ...
      return loading === "loading" ? (<Box display="flex" width="100vw" height="100vh" justifyContent="center" alignItems="center"><CircularProgress size={100} color="inherit"/></Box>) : loading === "Found_User" ? (<><TopNav/><BedStatus setLoading={setLoading}/></>) : (<LoginPage setLogin={setLogin} setLoading={setLoading} />)
}