...
export const NewVisitEntry = (props) => {
    ...
    const AddDoctorVisit = async () => {
      ...
      try{
        let result = await axios.post('http://192.168.1.108:5000/AddDoctorVisit', {ReceiptID: ReceiptID, DrId: Doctor.DrId, Date: VisitDate, NoOfVisit: NoOfVisit, Rate: Rate, Discount: Discount, Amount: Amount});
