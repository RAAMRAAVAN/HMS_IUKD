...
const { filterServiceMaster, createCaseEntry } = require('../controllers/CaseEntryController');
...
router.post('/filterIPDPatientAuto', IPDController.filterIPDPatientAuto)
...
router.post('/createCaseEntry', createCaseEntry)
