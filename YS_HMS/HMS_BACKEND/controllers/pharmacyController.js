...
ON PD.ReceiptID = S.SaleID where S.ActiveStatus='Y' and S.IsDelete='N' and S.InvoiceDate BETWEEN '${fromDate} 00:00:00.000' AND '${toDate} 23:59:59.000' and PD.Name='CASH CUSTOMER';`;

const query2 = `select sum(TotalAmount) as TotalAmount from TrnSales AS S
JOIN Trn_SalePaymentDetails AS PD
ON PD.ReceiptID = S.SaleID where S.ActiveStatus='Y' and S.IsDelete='N' and S.InvoiceDate BETWEEN '${fromDate} 00:00:00.000' AND '${toDate} 23:59:59.000' and PD.Name='ICICI Bank';`;

const query3 = `select sum(TotalAmount) as TotalAmount from TrnSales AS S
JOIN Trn_SalePaymentDetails AS PD
ON PD.ReceiptID = S.SaleID where S.ActiveStatus='Y' and S.IsDelete='N' and S.InvoiceDate BETWEEN '${fromDate} 00:00:00.000' AND '${toDate} 23:59:59.000' and PD.Name='HDFC Bank';`;

const query4 = `select sum(TotalAmount) as TotalAmount from TrnSales AS S
JOIN Trn_SalePaymentDetails AS PD
ON PD.ReceiptID = S.SaleID where S.ActiveStatus='Y' and S.IsDelete='N' and S.InvoiceDate BETWEEN '${fromDate} 00:00:00.000' AND '${toDate} 23:59:59.000' and PD.Name='Credit';`;
try {
  // Execute first query
